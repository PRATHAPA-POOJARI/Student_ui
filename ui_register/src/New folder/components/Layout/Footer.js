...
const Footer = ({ position = 'default' }) => {
    ...
    return (
        <Box sx={{ position: position === 'default' ? 'fixed' : 'relative', bottom: 0, left: 0, right: 0 }}>
            <Box sx={{ textAlign: "center", bgcolor: 'black', color: 'white', p: 10 }}>
                <Box sx={{
                    my: 1, // Reduced the vertical margin
                    "& svg": {
                        fontSize: "60px",
                        cursor: "pointer",
                        mr: 2,
